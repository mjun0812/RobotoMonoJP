...
macOS の場合は Homebrew で全 family を一括インストールできます。
...
個別ダウンロード: <https://github.com/mjun0812/RobotoMonoJP/releases>
...
| `nerd_font_glyph_scales` | -    | `{}`           | Nerd Font patch後に指定glyphをink中心基準で拡大縮小する倍率マップ。キーは `"F179"` か `"E000-E00A"` 形式 |
